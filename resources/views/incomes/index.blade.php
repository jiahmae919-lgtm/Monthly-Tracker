                                ...
                                @forelse($incomes as $income)
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                            <a href="{{ route('incomes.show', $income) }}" class="text-blue-600 dark:text-blue-400 hover:text-blue-900 mr-3">View</a>
                                            <a href="{{ route('incomes.edit', $income) }}" class="text-indigo-600 dark:text-indigo-400 hover:text-indigo-900 mr-3">Edit</a>
                                            <form method="POST" action="{{ route('incomes.destroy', $income) }}" class="inline">
                                                @csrf
                                                @method('DELETE')
